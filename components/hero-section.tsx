...
export function HeroSection() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute left-1/2 top-6 h-96 w-96 -translate-x-1/2 rounded-full bg-gradient-to-br from-[rgba(251,203,232,0.32)] via-[rgba(147,197,253,0.16)] to-[rgba(199,210,254,0)] blur-3xl" />
      ...
      <div className="relative px-4 py-20 sm:px-6 sm:py-24 lg:px-8">
        <div className="mx-auto max-w-5xl text-center text-[color:var(--foreground)]">
          ...
          <h1 className="mt-5 text-4xl font-semibold tracking-tight leading-[1.05] sm:text-5xl lg:text-6xl">
            {content.heroTitle}
          </h1>
          <p className="mx-auto mt-8 max-w-2xl text-base font-medium leading-8 text-[color:var(--foreground)] sm:text-lg sm:leading-9">
